...
A fully automated **txAdmin recipe** to install and run [Hades Framework](https://github.com/HadesStudios/hades-framework) — a modern, full-featured FiveM server framework built to streamline roleplay server development.
...
- ✅ Automatic GitHub download of the latest Hades Framework
...
➡️ [HadesStudios GitHub](https://github.com/HadesStudios/hades-framework)
...
If you encounter any issues with the recipe or want to contribute improvements, feel free to open an issue or PR on the [Hades txAdmin Recipe GitHub](https://github.com/Hades-Framework/txAdminRecipe).
